                        ...
                        <div className="flex justify-center mb-10 animate-fade-in-up animation-delay-100">
                            <div className="bg-white rounded-full p-1 shadow-md inline-flex">
                                <button
                                    ...
                                    className={`px-8 py-3 rounded-full text-lg font-bold font-fredoka transition-all ${activeTab === 'all'
                                ...
                                {userEmail && (
                                    <button
                                        ...
                                        className={`px-8 py-3 rounded-full text-lg font-bold font-fredoka transition-all ${activeTab === 'my'
                                            ? 'bg-story-purple text-white shadow-lg'
                                            : 'text-gray-600 hover:text-story-purple hover:bg-purple-50'
                                            }`}
                                    >
